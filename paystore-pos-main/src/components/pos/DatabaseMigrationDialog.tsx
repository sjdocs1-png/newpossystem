...
export const DatabaseMigrationDialog: React.FC<DatabaseMigrationDialogProps> = ({
  ...
  const handleSave = () => {
    ...
    localStorage.setItem('pos_database_migration', JSON.stringify(migrationData));
    
    toast.success('Database migration initiated successfully');
    handleClose();
  };
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-lg font-semibold">Database Migration</DialogTitle>
        </DialogHeader>
